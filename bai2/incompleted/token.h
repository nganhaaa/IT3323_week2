...
typedef enum {
  TK_NONE, TK_IDENT, TK_NUMBER, TK_CHAR, TK_EOF,TK_BYTES, TK_STRING,

  KW_PROGRAM, KW_CONST, KW_TYPE, KW_VAR,
  KW_INTEGER,   KW_BYTES, KW_CHAR, KW_ARRAY, KW_OF, KW_STRING,
  ...
  SB_PLUS, SB_MINUS, SB_POWER, SB_TIMES, SB_SLASH,
  SB_MOD,
